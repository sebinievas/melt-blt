...
class Plugin implements PluginInterface, EventSubscriberInterface {
   ...
   * Package name
   */
  const PACKAGE_NAME = 'meltmedia/blt';
  ...
  public static function getSubscribedEvents() {
    return array(
      ...
      ScriptEvents::PRE_INSTALL_CMD => array(
        array('onPreInstallCommandEvent', self::CALLBACK_PRIORITY),
      ),
      ScriptEvents::POST_UPDATE_CMD => array(
        array('onPostCommandEvent'),
      ),
   ...
   */
  public function onPreInstallCommandEvent(Event $event) {
  }
  ...
  public function onPostPackageEvent(PackageEvent $event) {
    ...
    if ($package) {
      // By explicitly setting the blt package, the onPostCommandEvent() will
   ...
   * @param \Composer\Script\Event $event
   */
  public function onPostCommandEvent(Event $event) {
  ...
  protected function getBltPackage($operation) {
    ...
    if (isset($package) && $package instanceof PackageInterface && $package->getName() == 'meltmedia/blt') {
      return $package;
    }
    return NULL;
  }
